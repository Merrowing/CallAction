...
public abstract class PhonecallReceiver extends BroadcastReceiver {
    ...
    public void onCallStateChanged(Context context, int state, String number) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, IOException, ClassNotFoundException {
        if(lastState == state){
